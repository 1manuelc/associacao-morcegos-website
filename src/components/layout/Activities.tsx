...
export function Activities() {
	...
	return (
		<section
			id='activities'
			className='py-20 bg-zinc-50 dark:bg-zinc-800 transition-colors duration-300'
		>
				...
				<div className='grid md:grid-cols-3 gap-6'>
					{activities.map((activity, index) => {
						...
						return (
							<div
								key={index}
								className={`bg-white dark:bg-zinc-700 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden group ${activity.className}`}
							>
