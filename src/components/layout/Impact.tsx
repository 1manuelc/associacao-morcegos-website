	...
	const testimonials = [
		{
			...
			text: 'Tá na Associação é privilégio, amplio meus conhecimentos através das oficinas e aulas ministradas pelos professores que nos trata com carinho, faço parte do projeto Asas so Saber - Morceguinhos.',
		},
		{
			name: 'Ana Carolina',
			...
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					...
					{stats.map((stat, index) => {
						...
						return (
							<div key={index} className='text-center'>
								<div className='bg-gradient-to-br from-primary-50 to-indigo-100 dark:from-zinc-700 dark:to-zinc-600 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4'>
				...
				<div className='text-center mt-16'>
					...
					<div className='flex flex-col sm:flex-row gap-4 justify-center'>
						<a
							href='#contact'
							className='bg-primary-500 dark:bg-primary-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-primary-600 dark:hover:bg-primary-700 transition-colors duration-200'
						>
							Quero Ajudar
						</a>
						...
						<a
							href='#activities'
							className='text-zinc-950 dark:text-white underline px-8 py-4 rounded-lg font-semibold hover:no-underline transition-colors duration-200'
						>
